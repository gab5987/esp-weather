...
\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard}{}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard}\index{ThrowTheSwitch.org Coding Standard@{ThrowTheSwitch.org Coding Standard}}
\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md134}%
\Hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md134}%
...
;)\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md135}{}\doxysection{\texorpdfstring{Why Have A Coding Standard?}{Why Have A Coding Standard?}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md135}
Being consistent makes code easier to understand. We\textquotesingle{}ve made an attempt to keep our standard simple because we also believe that we can only expect someone to follow something that is understandable. Please do your best.\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md136}{}\doxysection{\texorpdfstring{Our Philosophy}{Our Philosophy}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md136}
...
Speaking of having things Just Work™, that\textquotesingle{}s our second philosophy. By that, we mean that we do our best to have EVERY configuration option have a logical default. We believe that if you\textquotesingle{}re working with a simple compiler and target, you shouldn\textquotesingle{}t need to configure very much... we try to make the tools guess as much as they can, but give the user the power to override it when it\textquotesingle{}s wrong.\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md137}{}\doxysection{\texorpdfstring{Naming Things}{Naming Things}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md137}
Let\textquotesingle{}s talk about naming things. Programming is all about naming things. We name files, functions, variables, and so much more. While we\textquotesingle{}re not always going to find the best name for something, we actually put quite a bit of effort into finding \texorpdfstring{$\ast$}{*}\+What Something WANTS to be Called\texorpdfstring{$\ast$}{*}™.
...
\item Consistent
\item Memorable
\end{DoxyEnumerate}\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md138}{}\doxysubsubsection{\texorpdfstring{Readable}{Readable}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md138}
We want to read our code. This means we like names and flow that are more naturally read. We try to avoid double negatives. We try to avoid cryptic abbreviations (sticking to ones we feel are common).\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md139}{}\doxysubsubsection{\texorpdfstring{Descriptive}{Descriptive}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md139}
...
Second, loop counters and other local throw-\/away variables often have a purpose which is obvious. There\textquotesingle{}s no need, therefore, to get carried away with complex naming. We find i, j, and k are better loop counters than loop\+Counter\+Var or whatnot. We only break this rule when we see that more description could improve understanding of an algorithm.\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md140}{}\doxysubsubsection{\texorpdfstring{Consistent}{Consistent}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md140}
We like consistency, but we\textquotesingle{}re not really obsessed with it. We try to name our configuration macros in a consistent fashion... you\textquotesingle{}ll notice a repeated use of UNITY\+\_\+\+EXCLUDE\+\_\+\+BLAH or UNITY\+\_\+\+USES\+\_\+\+BLAH macros. This helps users avoid having to remember each macro\textquotesingle{}s details.\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md141}{}\doxysubsubsection{\texorpdfstring{Memorable}{Memorable}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md141}
Where ever it doesn\textquotesingle{}t violate the above principles, we try to apply memorable names. Sometimes this means using something that is simply descriptive, but often we strive for descriptive AND unique... we like quirky names that stand out in our memory and are easier to search for. Take a look through the file names in Ceedling and you\textquotesingle{}ll get a good idea of what we are talking about here. Why use preprocess when you can use preprocessinator? Or what better describes a module in charge of invoking tasks during releases than release\+\_\+invoker? Don\textquotesingle{}t get carried away. The names are still descriptive and fulfill the above requirements, but they don\textquotesingle{}t feel stale.\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md142}{}\doxysection{\texorpdfstring{C and C++ Details}{C and C++ Details}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md142}
...
We\textquotesingle{}ve decided on our own style preferences. If you\textquotesingle{}d like to contribute to these projects (and we hope that you do), then we ask if you do your best to follow the same. It will only hurt a little. We promise.\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md143}{}\doxysubsubsection{\texorpdfstring{Whitespace}{Whitespace}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md143}
...
\end{DoxyCode}
\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md144}{}\doxysubsubsection{\texorpdfstring{Case}{Case}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md144}
...
\end{DoxyItemize}\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md145}{}\doxysubsubsection{\texorpdfstring{Braces}{Braces}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md145}
...
\end{DoxyCode}
\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md146}{}\doxysubsubsection{\texorpdfstring{Comments}{Comments}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md146}
Do you know what we hate? Old-\/school C block comments. BUT, we\textquotesingle{}re using them anyway. As we mentioned, our goal is to support every compiler we can, especially embedded compilers. There are STILL C compilers out there that only support old-\/school block comments. So that is what we\textquotesingle{}re using. We apologize. We think they are ugly too.\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md147}{}\doxysection{\texorpdfstring{Ruby Details}{Ruby Details}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md147}
Is there really such thing as a Ruby coding standard? Ruby is such a free form language, it seems almost sacrilegious to suggest that people should comply to one method! We\textquotesingle{}ll keep it really brief!\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md148}{}\doxysubsubsection{\texorpdfstring{Whitespace}{Whitespace}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md148}
Our Ruby style is to use spaces and to use 2 of them per indent level. It\textquotesingle{}s a nice power-\/of-\/2 number that really grooves with Ruby\textquotesingle{}s compact style. We have no more reason than that. We break that rule when we have lines that wrap. When that happens, we like to indent further to line things up in nice tidy columns.\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md149}{}\doxysubsubsection{\texorpdfstring{Case}{Case}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md149}
...
\end{DoxyItemize}\hypertarget{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md150}{}\doxysection{\texorpdfstring{Documentation}{Documentation}}\label{md_lib_2c_j_s_o_n_2tests_2unity_2docs_2_throw_the_switch_coding_standard_autotoc_md150}
